...
TitleLabel.Text = "DEMONSTAR HUB"
TitleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
TitleLabel.TextScaled = true
TitleLabel.Font = Enum.Font.SourceSansBold

-- RunButton properties
RunButton.Parent = MainFrame
RunButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
RunButton.Size = UDim2.new(0.5, 0, 0, 50)
RunButton.Position = UDim2.new(0.5, -75, 0.5, -25)
RunButton.Text = "RUN"
...
OffButton.Size = UDim2.new(0.5, 0, 0, 50)
OffButton.Position = UDim2.new(0, 0, 0.5, -25)
OffButton.Text = "OFF"
OffButton.TextColor3 = Color3.fromRGB(255, 255, 255)
OffButton.TextScaled = true

-- Function to start auto Kaitun
local function autoKaitun()
    -- Your existing auto kaitun logic
    while IsRunning do
        -- Insert your existing code logic here
        wait(0.1)
    end
end

-- CheckLevel function (add the provided logic here)
local function CheckLevel()
    ...
    if Second_Sea then
        -- Similar checks for Second_Sea
        -- Add additional monster selection logic here based on Second_Sea level checks...
    end
end
...
RunButton.MouseButton1Click:Connect(function()
    if not IsRunning then
        ...
        CheckLevel()  -- Call CheckLevel function when RunButton is clicked
        autoKaitun()  -- Start the autoKaitun logic
    end
end)
